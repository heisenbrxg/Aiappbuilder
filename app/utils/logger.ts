...
// Default log level:
//   • Development: use `warn` to avoid console spam (can override with VITE_LOG_LEVEL=debug)
//   • Production (build): use `warn` to suppress verbose info output
// You can override via VITE_LOG_LEVEL environment variable (e.g., VITE_LOG_LEVEL=debug)
let currentLevel: DebugLevel = (import.meta.env.VITE_LOG_LEVEL as DebugLevel) || 'warn';
