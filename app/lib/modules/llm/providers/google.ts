...
export default class GoogleProvider extends BaseProvider {
  ...
  staticModels: ModelInfo[] = [
    ...
    /*
     * Gemini 1.5 - Stable fallback models
     */
    {
      name: 'gemini-1.5-pro',
      ...
      maxCompletionTokens: 8192,
      isPaid: true,
      description: 'Stable, reliable model with 2M context - excellent fallback'
    },
    {
      ...
      maxCompletionTokens: 8192,
      isPaid: false,
      description: 'Fast and cost-effective model with 1M context'
    },
  ];
