...
export async function streamText(props: {
  ...
  // CRITICAL: Always load ALL models (dynamic + filtered static) from manager
  // manager.ts already handles: dynamic models FIRST, then filtered static (no duplicates)
  // This ensures API-provided limits override hardcoded static values
  ...
  // Search through combined list - dynamic models will be found first (manager returns them first)
  ...
  // Use maxCompletionTokens for reasoning models (o1, o3, GPT-5), maxTokens for traditional models
