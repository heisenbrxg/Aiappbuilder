...
---
  ...
  logger.info(`Total files selected for new context buffer: ${totalFiles}`);

  // If the model decided that no additional files are necessary, simply return the (possibly empty)
  // map instead of throwing – an empty selection is perfectly valid and should not surface as an
