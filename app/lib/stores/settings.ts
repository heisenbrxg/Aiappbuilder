...
// Supported providers: Anthropic, OpenAI, Google, Deepseek, Mistral, xAI, Perplexity
export const DISABLED_PROVIDERS: string[] = [
  'AmazonBedrock',
  'Github',
  'HuggingFace',
  'Hyperbolic',
...
const getInitialProviderSettings = (): ProviderSetting => {
  ...
  PROVIDER_LIST.forEach((provider) => {
    const isDisabled = DISABLED_PROVIDERS.includes(provider.name);
