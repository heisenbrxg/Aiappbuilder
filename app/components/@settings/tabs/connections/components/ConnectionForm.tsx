...
export function ConnectionForm({ authState, setAuthState, onSave, onDisconnect }: ConnectionFormProps) {
  ...
  return (
    <div className="rounded-xl bg-white dark:bg-[#1E1E21] border border-[#E5E5E5] dark:border-[#1A1A1A] overflow-hidden">
      <div className="p-6">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            <div className="p-2 rounded-lg bg-[#F5F5F5] dark:bg-[#1A1A1A] border border-[#E5E5E5] dark:border-[#1A1A1A]">
              <div className="i-ph:plug-fill text-monzed-elements-textTertiary" />
            </div>
            <div>
              <h3 className="text-lg font-medium text-monzed-elements-textPrimary">Connection Settings</h3>
              <p className="text-sm text-monzed-elements-textSecondary">Configure your GitHub connection</p>
            </div>
          </div>
        </div>
        ...
        <form onSubmit={onSave} className="space-y-4">
          <div>
            <label htmlFor="username" className="block text-sm font-medium text-monzed-elements-textSecondary mb-2">
              GitHub Username
            </label>
            <input
              id="username"
              ...
              className={classNames(
                ...
                'text-monzed-elements-textPrimary placeholder-monzed-elements-textTertiary text-base',
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              <label htmlFor="token" className="block text-sm font-medium text-monzed-elements-textSecondary">
          ...
          <div className="flex items-center justify-between pt-4 border-t border-[#E5E5E5] dark:border-[#1A1A1A]">
            ...
            {authState.rateLimits && (
              <div className="flex items-center gap-2 text-sm text-monzed-elements-textTertiary">
