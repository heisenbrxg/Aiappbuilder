          ...
          >
            <Dialog.Content className="bg-white dark:bg-[#1A1A1A] rounded-lg shadow-xl max-w-sm w-full mx-4 overflow-hidden">
              <div className="p-4 space-y-3">
                ...
                <div className="bg-[#F9F9F9] dark:bg-[#252525] p-4 rounded-lg space-y-3">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-3">
                    ...
                    <button
                      ...
                      className="w-full py-2 bg-red-500 hover:bg-red-600 text-white rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed text-sm"
                    >
                ...
                <div className="p-3 rounded-lg space-y-1.5 bg-monzed-elements-background-depth-2 dark:bg-monzed-elements-background-depth-3 border border-monzed-elements-borderColor">
                  <h3 className="text-sm text-monzed-elements-textPrimary dark:text-monzed-elements-textPrimary-dark font-medium flex items-center gap-1.5">
                    <span className="i-ph:warning-circle w-4 h-4" />
                    Accessing Private Repositories
                  </h3>
                  <p className="text-xs text-monzed-elements-textSecondary dark:text-monzed-elements-textSecondary-dark">
                    Important things to know about accessing private repositories:
                  </p>
                  <ul className="list-disc pl-4 text-xs text-monzed-elements-textSecondary dark:text-monzed-elements-textSecondary-dark space-y-0.5">
