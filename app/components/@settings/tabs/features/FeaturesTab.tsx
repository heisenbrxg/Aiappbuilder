      ...
      <div className="p-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className={classNames(feature.icon, 'w-5 h-5 text-monzed-elements-textSecondary')} />
            <div className="flex items-center gap-2">
              <h4 className="font-medium text-monzed-elements-textPrimary">{feature.title}</h4>
              {feature.beta && (
        ...
        <p className="mt-2 text-sm text-monzed-elements-textSecondary">{feature.description}</p>
        {feature.tooltip && <p className="mt-1 text-xs text-monzed-elements-textTertiary">{feature.tooltip}</p>}
      </div>
    </motion.div>
  ),
);
...
const FeatureSection = memo(
  ({
    ...
    >
      <div className="flex items-center gap-3">
        <div className={classNames(icon, 'text-xl text-red-500')} />
        <div>
          <h3 className="text-lg font-medium text-monzed-elements-textPrimary">{title}</h3>
          <p className="text-sm text-monzed-elements-textSecondary">{description}</p>
        </div>
      </div>
...
export default function FeaturesTab() {
  ...
  const handleToggleFeature = useCallback(
    ...
    [enableLatestBranch, setAutoSelectTemplate, enableContextOptimization],
  );
        ...
        <div className="flex items-center gap-4">
          ...
          <select
            ...
            className={classNames(
              ...
              'bg-monzed-elements-background-depth-3 border border-monzed-elements-borderColor',
