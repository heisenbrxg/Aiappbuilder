...
const OPTIONAL_USER_TABS: TabType[] = ['profile', 'settings', 'debug'];
...
const BetaLabel = () => (
  <span className="px-1.5 py-0.5 text-[10px] rounded-full bg-red-500/10 text-red-500 font-medium">BETA</span>
);
          ...
          <div className="flex items-center gap-2">
            <div
              className={classNames(
                ...
                'bg-monzed-elements-background-depth-3',
                'text-red-500',
              )}
            >
            ...
            <div>
              <h4 className="text-md font-medium text-monzed-elements-textPrimary">Tab Management</h4>
              <p className="text-sm text-monzed-elements-textSecondary">Configure visible tabs and their order</p>
            </div>
          </div>
          ...
          <div className="relative w-64">
            ...
            <input
              ...
              className={classNames(
                ...
                'placeholder-monzed-elements-textTertiary',
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          {filteredTabs.some((tab) => DEFAULT_USER_TABS.includes(tab.id)) && (
            <div className="col-span-full flex items-center gap-2 mt-4 mb-2">
              <div className="i-ph:star-fill w-4 h-4 text-red-500" />
              <span className="text-sm font-medium text-monzed-elements-textPrimary">Default Tabs</span>
            </div>
          )}
          ...
          {filteredTabs
            ...
            .map((tab, index) => (
              <motion.div
                key={tab.id}
                className={classNames(
                  'rounded-lg border bg-monzed-elements-background text-monzed-elements-textPrimary',
                  'bg-monzed-elements-background-depth-2',
              ...
              >
                ...
                <div className="absolute top-1 right-1.5 flex gap-1">
                  <span className="px-1.5 py-0.25 text-xs rounded-full bg-red-500/10 text-red-500 font-medium mr-2">
                    Default
                  </span>
                </div>
                ...
                <div className="flex items-start gap-4 p-4">
                  <motion.div
                    className={classNames(
                      ...
                      'bg-monzed-elements-background-depth-3 group-hover:bg-monzed-elements-background-depth-4',
                      'transition-all duration-200',
                      tab.visible ? 'text-red-500' : 'text-monzed-elements-textSecondary',
                    )}
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between gap-4">
                      <div>
                        <div className="flex items-center gap-2">
                          <h4 className="text-sm font-medium text-monzed-elements-textPrimary group-hover:text-red-500 transition-colors">
                            {TAB_LABELS[tab.id]}
                          </h4>
                          {BETA_TABS.has(tab.id) && <BetaLabel />}
                        </div>
                        <p className="text-xs text-monzed-elements-textSecondary mt-0.5">
                      ...
                      <Switch
                        ...
                        className={classNames('data-[state=checked]:bg-red-500 ml-4', {
                ...
                <motion.div
                  className="absolute inset-0 border-2 border-red-500/0 rounded-lg pointer-events-none"
                  animate={{
                    borderColor: tab.visible ? 'rgba(239, 68, 68, 0.2)' : 'rgba(239, 68, 68, 0)',
          ...
          {filteredTabs.some((tab) => OPTIONAL_USER_TABS.includes(tab.id)) && (
            <div className="col-span-full flex items-center gap-2 mt-8 mb-2">
              ...
              <span className="text-sm font-medium text-monzed-elements-textPrimary">Optional Tabs</span>
            </div>
          )}
