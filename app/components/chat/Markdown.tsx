      ...
      return {
        div: ({ className, children, node, ...props }) => {
          ...
          if (className?.includes('__boltArtifact__')) {
            ...
            if (!messageId && !artifactId) {
              logger.error(`Invalid message id and artifact id`);
            }
          ...
          if (className?.includes('__boltSelectedElement__')) {
            ...
            return (
              <div className="bg-monzed-elements-background-depth-3 border border-monzed-elements-borderColor rounded-lg p-3 my-2">
                <div className="flex items-center gap-2 mb-2">
                  <span className="text-xs font-mono bg-monzed-elements-background-depth-2 px-2 py-1 rounded text-monzed-elements-textTer">
                    {elementData?.tagName}
                  </span>
                  {elementData?.className && (
                    <span className="text-xs text-monzed-elements-textSecondary">.{elementData.className}</span>
                  )}
                </div>
                <code className="block text-sm !text-monzed-elements-textSecondary !bg-monzed-elements-background-depth-2 border border-monzed-elements-borderColor p-2 rounded">
        ...
        pre: (props) => {
          ...
          if (
            ...
            return <CodeBlock code={firstChild.children[0].value} language={language} showLineNumbers={false} />;
          }
        ...
        button: ({ node, children, ...props }) => {
          ...
          if (
            ...
            return (
              <button
                className="rounded-md justify-center px-3 py-1.5 text-xs bg-monzed-elements-item-backgroundAccent text-monzed-elements-item-contentAccent opacity-90 hover:opacity-100 flex items-center gap-2 cursor-pointer"
                data-type={type}
