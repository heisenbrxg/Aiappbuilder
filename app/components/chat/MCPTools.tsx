  ...
  return (
    <div className="relative">
      <div className="flex">
        ...
        >
          {!isInitialized ? (
            <div className="i-svg-spinners:90-ring-with-bg text-monzed-elements-loader-progress text-xl animate-spin"></div>
          ) : (
            <div className="i-monzed:mcp text-xl"></div>
          )}
        </IconButton>
      </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  {serverEntries.length > 0 ? (
                    ...
                    <div className="py-4 text-center text-monzed-elements-textSecondary">
                ...
                <div>{error && <p className="mt-2 text-sm text-monzed-elements-icon-error">{error}</p>}</div>
              </div>
