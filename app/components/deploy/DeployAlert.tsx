          ...
          >
            <div
              className={classNames(
                'text-xl',
                type === 'success'
                  ? 'i-ph:check-circle-duotone text-monzed-elements-icon-success'
                  : type === 'error'
                    ? 'i-ph:warning-duotone text-monzed-elements-button-danger-text'
                    : 'i-ph:info-duotone text-monzed-elements-loader-progress',
              )}
            ></div>
          </motion.div>
          {/* Content */}
                ...
                <div className="mt-4 mb-2">
                  <div className="flex items-center space-x-2 mb-3">
                    ...
                    <div className="flex items-center">
                      <div
                        className={classNames(
                          ...
                          buildStatus === 'running'
                            ? 'bg-monzed-elements-loader-progress'
                            : buildStatus === 'complete'
                              ? 'bg-monzed-elements-icon-success'
                              : buildStatus === 'failed'
                                ? 'bg-monzed-elements-button-danger-background'
                                : 'bg-monzed-elements-textTertiary',
                        )}
                      >
                        {buildStatus === 'running' ? (
                    ...
                    <div
                      className={classNames(
                        'h-0.5 w-8',
                        buildStatus === 'complete' ? 'bg-monzed-elements-icon-success' : 'bg-monzed-elements-textTertiary',
                      )}
                    ></div>
              ...
              {url && type === 'success' && (
                <div className="mt-2">
                  <a
                    ...
                    className="text-monzed-elements-item-contentAccent hover:underline flex items-center"
                  >
