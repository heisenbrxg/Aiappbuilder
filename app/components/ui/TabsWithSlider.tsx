...
export function TabsWithSlider({
  ...
  return (
    <div className={classNames('relative flex gap-2', className)}>
      ...
      {tabs.map((tab, index) => (
        <button
          ...
          className={classNames(
            ...
            tab.id === activeTab
              ? classNames('text-white shadow-sm shadow-red-500/20', activeTabClassName)
              : classNames(
                  'bg-monzed-elements-background-depth-2 dark:bg-monzed-elements-background-depth-3 text-monzed-elements-textPrimary dark:text-monzed-elements-textPrimary-dark hover:bg-monzed-elements-background-depth-3 dark:hover:bg-monzed-elements-background-depth-4 border border-monzed-elements-borderColor dark:border-monzed-elements-borderColor-dark',
                  tabClassName,
                ),
          )}
        >
      ...
      {/* Animated slider */}
      <motion.div
        className={classNames('absolute bottom-0 left-0 h-10 rounded-lg bg-red-500 -z-10', sliderClassName)}
        initial={false}
        animate={{
