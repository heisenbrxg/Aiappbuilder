  ...
  return (
    <div
      ...
      className={classNames(
        'rounded-lg border border-monzed-elements-borderColor bg-monzed-elements-background-depth-1 text-monzed-elements-textPrimary shadow-sm',
        className,
      )}
      {...props}
    />
...
const CardDescription = forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLParagraphElement>>(
  ({ className, ...props }, ref) => {
    return <p ref={ref} className={classNames('text-sm text-monzed-elements-textSecondary', className)} {...props} />;
  },
);
