      ...
      <div className="flex items-center gap-1.5">
        ...
        <span
          className={classNames(
            isLast
              ? 'font-medium text-monzed-elements-textPrimary dark:text-monzed-elements-textPrimary-dark'
              : 'text-monzed-elements-textSecondary dark:text-monzed-elements-textSecondary-dark hover:text-monzed-elements-textPrimary dark:hover:text-monzed-elements-textPrimary-dark',
            ...
            <li key={index} className="flex items-center">
              ...
              {!isLast && (
                <span
                  className={classNames(
                    separator,
                    'w-3 h-3 mx-1 text-monzed-elements-textTertiary dark:text-monzed-elements-textTertiary-dark',
                  )}
                />
              )}
            </li>
