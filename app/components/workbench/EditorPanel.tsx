...
export const EditorPanel = memo(
  ({
    ...
    // monzed.diy pattern: Debounce editor changes inline (500ms)
    const timeoutRef = useRef<NodeJS.Timeout>();
    const debouncedOnEditorChange = useCallback<OnEditorChange>(
      (update) => {
    ...
    return (
      <PanelGroup direction="horizontal">
            <Panel defaultSize={20} minSize={15} collapsible className="border-r border-monzed-elements-borderColor">
              <div className="h-full">
                <Tabs.Root defaultValue="files" className="flex flex-col h-full">
                  <PanelHeader className="w-full text-sm font-medium text-monzed-elements-textSecondary px-1">
                      ...
                      <Tabs.List className="h-full flex-shrink-0 flex items-center">
                        <Tabs.Trigger
                          ...
                          className={classNames(
                            'h-full bg-transparent hover:bg-monzed-elements-background-depth-3 py-0.5 px-2 rounded-lg text-sm font-medium text-monzed-elements-textTertiary hover:text-monzed-elements-textPrimary data-[state=active]:text-monzed-elements-textPrimary',
                          )}
                        >
                          Files
                        </Tabs.Trigger>
